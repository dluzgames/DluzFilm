...
Column {
    ...
    ThemedLabel {
        ...
        text: qsTr("Let Antigravity, Codex, Cursor or Claude edit this project for you — add clips, change the timeline, and check how it looks. Only programs on this device. Starts off each time you open Dluz Film; turn it off when you finish. The key stays the same between sessions, so a setup you pasted once keeps working.")
    }
