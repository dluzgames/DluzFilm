    ...
    Column {
        ...
        Text {
            ...
            text: root.keyframeMode
                  ...
                  : qsTr("Smooths camera shake. Dluz Film scans the clip once, then renders a new video. Changing smoothness or tripod does not update the preview until you apply.")
