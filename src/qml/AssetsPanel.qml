    ...
    Connections {
        ...
        function onFolderImportFinished(folders, files, skipped, truncated) {
            if (folders === 0) {
                ...
                Toasts.warning(qsTr("Imported %n files into %1 folders. %2 files were skipped — Dluz Film does not recognize their format. Drag them onto the bin to try anyway.", "", files).arg(folders).arg(skipped))
            } else {
