...
Rectangle {
    ...
    readonly property var projectFilter: [
        qsTr("All Supported Projects (*.drift *.prproj *.xml *.drp *.kdenlive *.edl *.json)"),
        qsTr("Dluz Film project (*.drift)"),
        qsTr("Premiere Pro project (*.prproj)"),
        qsTr("DaVinci Resolve project (*.drp *.edl)"),
    ...
    RowLayout {
        ...
        Row {
            ...
            IconButton {
                ...
                tooltip: qsTr("Agente IA Interno (Antigravity CLI, Codex CLI, OpenCode, Gemini, Groq, OpenRouter)")
                anchors.verticalCenter: parent.verticalCenter
