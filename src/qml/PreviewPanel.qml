                ...
                Rectangle {
                    ...
                    EmptyState {
                        ...
                        hint: EditorState.playback.gpuCompositorStatus === "version-too-low"
                              ...
                              ? qsTr("Your graphics driver only provides %1. Dluz Film's preview needs OpenGL 3.3.")
                                    .arg(EditorState.playback.gpuCompositorDetail)
                              : qsTr("Dluz Film could not start its GPU renderer, so the preview cannot draw.")
